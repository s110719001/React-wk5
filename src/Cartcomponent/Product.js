                ...
                <Col span={18} className='shopping-col'>
                    <div className='shopping-content'>
                        ...
                        <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                            ...
                            <img
                                style={{width:'14em',height:'14em',marginTop:'1em',marginRight:'1em'}}
                            ...
                            <div style={{flexDirection:'column',textAlign:'start',padding:'1em 15em 1em 0'}}>
                                ...
                                <div style={{display:'flex',flexDirection:'row'}}>
                                    <p style={{color:'white',backgroundColor:'#e5821c',paddingInline:'5px',borderTopLeftRadius:'10px',borderBottomLeftRadius:'10px',margin:'0'}}>#1 Best Seller</p>
                                    <p style={{color:'#98a3b2',margin:'0',marginLeft:'0.5em'}}>in Mac Game Headsets</p>
                                </div>
                                <p style={{color:'#7fba7f'}}>In Stock</p>
                                <p style={{color:'#98a3b2'}}>FREE Shipping to Taiwan when you spend over $75.00 on eligible items.</p>
                                <div style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
                                ...
                                <div style={{display:'flex',flexDirection:'row'}}>
                                    ...
                                    <a style={{marginInline:'0.5em'}}>Delete</a>
                                    <div style={{width:'1px',height:'1em',backgroundColor:'#98a3b2',alignSelf:'center'}}></div>
                                    <a style={{marginInline:'0.5em'}}>Save for later</a>
                                    <div style={{width:'1px',height:'1em',backgroundColor:'#98a3b2',alignSelf:'center'}}></div>
                                    <a style={{marginLeft:'0.5em'}}>Compare with similar Items</a>
                                </div>
                            </div>
